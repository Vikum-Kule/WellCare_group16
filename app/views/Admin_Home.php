...
background-image: url("https://order-medicine-online.com/wp-content/uploads/2019/09/Buy-Medicines-Online.jpg");
 height: 100%; 
          ...
          <li><div class="dropdown">
            ...
            <li><div class="dropdown">
                 ...
                 <button class="dropbtn">DELIVERY</button>
                    <div class="dropdown-content">
                     <a href="http://localhost/mvcfinal/admin_Deliverys/register1">Registration</a>
                     <a href="http://localhost/mvcfinal/admin_Deliverys/login1">Login</a>
